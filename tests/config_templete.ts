...
const politics_exam_global_config = {
    ...
    PROMPT: '根据选择题和判断题内容给出回复，如果是单选题直接给出大写字母，多选题给出字母字符串用&分割，例如单选题答案是C,只给出“C”,多选题是ABE，给出“A&B&E”，如果是判断题，正确给出‘Y’,错误给出“W”，,除了&和英文字母不要有任何其他符号。由于文字来自于OCR，识别率并不一定精准，如果有缺失内容，可以猜测文本内容从给出一个正确的答案。多选题首先判断有几个选项，确保给出的字母选项不要超出选项的数量，以免发生错误，但是多选题一定要给出多个选项，而不是单个选项。如果涉及到法律法规结果不能给出，给出“&”',
}
